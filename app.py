...
db = mysql.connector.connect(host="localhost", user="root", passwd="", database="missing_child")
cur = db.cursor()
        ...
        for (x, y, w, h) in faces:
            ...
            if (conf > 50):
                ...
                if det==10:
                    ...
                    val=(tt,cname,pname,pnumber,date,timeStamp,email,noOfFile)
                    cur.execute(sql,val)
                    db.commit()
                    msg = 'Dear Sir,'
                    ...
                    dt = "Detected on "
                    tm= 'at '
                    im = "Kindly take necessary actions. "
                    t = 'Regards,'
                    t1 = 'Missing Child Identification Center.'
                    mail_content = msg + ',' + '\n' + m + ' ' + str(tt) +'.'+ dt +  date + tm + timeStamp + '.' + im + '\n' + '\n' + t + '\n' + t1
                    sender_address = 'kallukurivyshnavi@gmail.com'
                    sender_pass = 'pvwa gupc dvia myzm'
                    receiver_address = 'kallukurivyshnavi@gmail.com'
                    ...
                    with open('Missing_Child/'+noOfFile, 'rb') as f:
                        image_data = f.read()
